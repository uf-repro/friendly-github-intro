...
Good project management *saves time*, making it easy to:
...
* multiple collaborators working on the same files at the same time
---
...
Commits are constructed *manually* - you tell git which changes (since the last version) to include.

This can be tedious, but gives you precise control over what changes to record.
