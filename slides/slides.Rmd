...
Good practices *save time* in project management and make it easy to:
...
* Dropbox / Google Drive / OneDrive can show previous versions
...
* find a specific version of the project (with many different files/folders)
* knowing *who* made changes and  *why*
* multiple collaborators working at the same time
---
...
* In Git, a project is a folder
  - the folder is called a *repository* or *repo*
  - Git tracks changes to all files and subfolders of that folder
* Project changes are tracked by taking snapshots:
...
* each commit is constructed *manually*
  - can be tedious, but gives you precise control over what changes to record
* `add` files that have changed (including new files)
  - Git only records changes, so only the changed files need to be noted
